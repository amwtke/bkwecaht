...
namespace BK.CommonLib.Qiniu
{
    public class QiniuHelper
    {
        ...
        private static Model.Configuration.PaaS.QiniuConfig config = Configuration.BK_ConfigurationManager.GetConfig<Model.Configuration.PaaS.QiniuConfig>();
        private void Init()
        {
            if(!init)
            {
                if(config == null)
                    Util.WebApiHelper.HttpRMtoJson(null, System.Net.HttpStatusCode.OK, Util.customStatus.Fail);
                else
                {
