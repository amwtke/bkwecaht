...
namespace BK.CommonLib.ElasticSearch
{
    public static class LocationManager
    {
        ...
        {
            LogHelper.LogErrorAsync(typeof(LocationManager), ex);
        }
        static ElasticClient _client = null;
        static LocationConfig _config = null;//BK_ConfigurationManager.GetConfig<LocationConfig>();
        static LocationManager()
        {
            ...
            _config = BK_ConfigurationManager.GetConfig<LocationConfig>();
            if (_config == null)
            {
