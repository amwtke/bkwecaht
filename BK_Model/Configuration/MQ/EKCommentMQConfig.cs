...
{
    [BKConfig("MQ", "EKComment")]
    public class EKCommentMQConfig : IConfigModel, IMQConfig
    {
        [BKKey("HostName")]
    ...
    [BKConfig("MQ", "PaperComment")]
    public class PaperCommentMQConfig : IConfigModel, IMQConfig
    {
        [BKKey("HostName")]
        public string HostName { get; set; }
